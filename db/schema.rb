...
ActiveRecord::Schema[8.0].define(version: 2025_08_31_064444) do
  ...
  create_table "video_progresses", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["lesson_id"], name: "index_video_progresses_on_lesson_id"
  ...
  add_foreign_key "video_progresses", "lessons"
